...
// Wirrit, since apparently I need to sign shit, 2012-07-something.
#include "includes.h"
using namespace std;
...
string namegenerator::getsyllablestructure()
{
      ...
      if ((finalname.length == 5) and (structure=="CVV")) {structure = "CVC";};
...
{
     finalname.text =      trollname[0].text + trollname[1].text;
     if (trollname[2].text != "") finalname.text = finalname.text + trollname[2].text;
     if (trollname[3].text != "") finalname.text = finalname.text + trollname[3].text;
     if (trollname[4].text != "") finalname.text = finalname.text + trollname[4].text;
     if (trollname[5].text != "") finalname.text = finalname.text + trollname[5].text;
...
// Loop:  Constructing the initial name, until length = 6
        while (finalname.length < 6) {
            ...
            if ((trollname[finalname.numsyl - 2].structure == "CVV") and (trollname[finalname.numsyl - 1].structure == "V")) {testspassed = testspassed - 1;};
